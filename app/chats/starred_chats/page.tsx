      ...
      <header className="flex h-16 shrink-0 items-center gap-2 border-b border-slate-700 bg-dark-600 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12">
        <div className="flex items-center gap-2 px-4">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              <BreadcrumbItem>
                <BreadcrumbPage className="text-slate-300">Starred Chats</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {!isClient ? (
            ...
            <div className="col-span-full flex flex-col items-center justify-center p-10 text-center">
              ...
              <h3 className="text-xl font-medium mb-2">No starred chats found</h3>
              <p className="text-muted-foreground mb-4">Star chats to add them to this list.</p>
              <Link href="/all_chats">
